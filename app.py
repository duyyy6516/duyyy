...
# Cập nhật ngưỡng vào session_state để hàm MQTT chạy ngầm đọc được
...
# --- CƠ CHẾ LẮNG NGHE MQTT VÀ XỬ LÝ GỬI TELEGRAM TRỰC TIẾP ---
...
if not df.empty:
    ...
    st.info("🔌 Hệ thống đang mở cổng sóng, chờ thiết bị bắn dữ liệu MQTT qua mạng...")
