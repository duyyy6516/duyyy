...
low_threshold = st.slider("Ngưỡng VPD Thấp:", 0.1, 1.5, key="slider_low")
high_threshold = st.slider("Ngưỡng VPD Cao:", 1.0, 3.0, key="slider_high")
...
if st.session_state.is_running:
    ...
    # BỘ ĐẾM NGƯỢC 30S (UI)
    countdown_html = """
    <div style="background-color: #f0f2f6; padding: 12px; border-radius: 8px; border-left: 5px solid #1f77b4;">
        <span style="font-weight: bold;">⏱️ ĐỒNG HỒ CHU KỲ QUÉT:</span> 
