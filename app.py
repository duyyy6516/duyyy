...
def process_incoming_data(df_new):
    ...
    # CRITICAL FIX: Nếu người dùng bấm DỪNG LẠI, hủy bỏ xử lý dữ liệu và KHÔNG gửi Telegram
...
if st.session_state.is_running:
    ...
    countdown_placeholder.markdown("⏸️ **Hệ thống đang tạm dừng toàn diện (Đã khóa cổng đẩy Telegram).**")
